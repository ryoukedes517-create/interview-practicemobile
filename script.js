...
const questions = [
  ...
  {
    category: "第3問・選んだ理由",
    question: "当社を選んだ理由は何ですか?",
    criteria: ["選んだ理由を言えているか", "その理由を説明できているか", "入社への意欲を伝えられているか"],
    groups: [
      ["御社", "貴社", "当社", "会社", "選び", "理由", "魅力"],
      ["から", "ため", "ので", "理由", "なぜなら", "理念", "環境", "仕事"],
      ["入社", "働きたい", "頑張", "努力", "成長", "貢献"]
    ],
    type: "generic"
  },
...
const UPDATED_QUESTION_GUIDANCE = {
  ja: [
    ...
    [
      ["選んだ理由を述べています。", "選んだ理由が含まれていません。", "当社を選んだ理由を一つ述べてください。"],
      ["その理由を説明しています。", "選んだ理由の説明が不足しています。", "魅力に感じた点や自分に合う点を一つ加えてください。"],
      ["入社への意欲を伝えています。", "入社への意欲が不足しています。", "入社後に頑張りたいことを加えてください。"]
    ],
    [
