...
const questions = [
  ...
  },
  {
    category: "第2問・志望理由",
    question: "志望理由は何ですか?",
    criteria: ["志望理由を言えているか", "理由を説明できているか", "前向きな気持ちを伝えられているか"],
    groups: [
      ["志望", "理由", "応募", "希望", "働きたい", "入社", "入学", "選び"],
      ["から", "ため", "ので", "理由", "なぜなら", "経験", "興味", "魅力", "学び"],
      ["たい", "頑張", "努力", "成長", "前向き", "挑戦", "貢献", "学びたい"]
    ],
    type: "generic"
  },
  {
    category: "第3問・選んだ理由",
    question: "当社(校)を選んだ理由は何ですか?",
    criteria: ["選んだ理由を言えているか", "その理由を説明できているか", "入社(入学)への意欲を伝えられているか"],
    groups: [
      ["御社", "貴社", "当社", "会社", "学校", "当校", "貴校", "選び", "理由", "魅力"],
      ["から", "ため", "ので", "理由", "なぜなら", "理念", "環境", "授業", "仕事", "学べる"],
      ["入社", "入学", "働きたい", "学びたい", "頑張", "努力", "成長", "貢献"]
    ],
    type: "generic"
  },
  {
    category: "第4問・頑張ったこと",
    question: "これまでで一番頑張ったことは何ですか?",
    criteria: ["頑張ったことを言えているか", "内容を説明できているか", "学んだことや成長を伝えられているか"],
    groups: [
      ["仕事", "アルバイト", "学校", "勉強", "日本語", "ボランティア", "部活", "プロジェクト", "頑張"],
      ["とき", "毎日", "年間", "か月", "時間", "例えば", "担当", "目標", "内容", "努力"],
      ["学び", "学ん", "成長", "できるよう", "身につ", "合格", "達成", "改善"]
    ],
    type: "generic"
  },
  {
    category: "第5問・長所",
    question: "あなたの長所は何ですか?",
    criteria: ["長所を言えているか", "理由や具体例を話せているか", "それを仕事でどう生かしたいか話せているか"],
    groups: [
      ["長所", "強み", "まじめ", "責任感", "協力", "継続", "明る", "行動", "聞く", "粘り強"],
      ["理由", "例えば", "とき", "経験", "毎日", "以前", "学校", "仕事", "アルバイト", "から"],
      ["仕事", "活か", "生か", "役に立", "貢献", "職場", "業務", "頑張"]
    ],
    type: "generic"
  },
  {
    category: "第6問・ミスへの対応",
    question: "仕事でミスをしたらどうしますか?",
    criteria: ["上司にすぐ報告すると言えているか", "原因を自分で考えると言えているか", "上司の指示を聞いて対応すると言えているか"],
    groups: [
      ["上司", "先輩", "責任者", "報告", "すぐ", "すみやか", "伝え"],
      ["原因", "理由", "なぜ", "自分", "考え", "確認", "振り返"],
      ["上司", "指示", "聞", "相談", "対応", "直", "行動"]
    ],
    type: "generic"
  },
  {
    ...
    criteria: ["弱みを正直に言えているか", "どのように改善しようとしているか話せているか", "前向きな姿勢で締めくくっているか"],
    groups: [
      ["弱み", "短所", "苦手", "緊張", "心配", "慎重", "遠慮", "正直"],
      ["改善", "直", "練習", "準備", "確認", "相談", "メモ", "意識", "努力"],
      ["前向き", "頑張", "努力", "続け", "成長", "できるよう", "心がけ"]
    ],
    type: "generic"
  },
  {
    category: "第8問・チームワーク",
    question: "チームで仕事をするときに大切なことは何ですか?",
    criteria: ["チームで大切なことを言えているか", "理由や具体例を話せているか", "仕事でどう実践したいか話せているか"],
    groups: [
      ["チーム", "大切", "協力", "報告", "相談", "聞く", "尊重", "思いやり"],
      ["理由", "から", "ため", "ので", "例えば", "経験", "とき"],
      ["仕事", "実践", "報告", "相談", "協力", "声をかけ", "聞", "伝え"]
    ],
    type: "generic"
  },
  {
    category: "第9問-1・日本語への不安",
    question: "日本語に不安はありますか?",
    criteria: ["「はい、あります。」または「いいえ、ありません。」と答えられているか"],
    groups: [
      ["はい", "あります", "いいえ", "ありません", "ないです", "不安"]
    ],
    type: "generic"
  },
  {
    category: "第9問-2・不安の内容",
    question: "どんなことに不安を感じますか?",
    criteria: ["何が不安なのかを伝えられているか", "そのために何をしているか話せているか"],
    groups: [
      ["不安", "心配", "言葉", "会話", "敬語", "専門用語", "聞き取", "話す", "読む"],
      ["勉強", "練習", "確認", "質問", "メモ", "復習", "相談", "努力", "準備"]
    ],
    type: "generic"
  },
  {
    category: "第10問・将来像",
    question: "将来の目標は何ですか?",
    criteria: ["将来の目標を言えているか", "そのために今何をしているか話せているか", "前向きな気持ちを伝えているか"],
    groups: [
      ["将来", "目標", "なりたい", "人材", "リーダー", "専門", "信頼", "役に立"],
      ["今", "勉強", "努力", "経験", "資格", "学び", "練習", "準備", "続け"],
      ["たい", "頑張", "努力", "成長", "前向き", "挑戦", "貢献"]
    ],
    type: "generic"
  }
];
...
function scoreCurrentAnswer(rawAnswer) {
  ...
  if (maximum !== 25) {
    scores = scores.map((score) => Math.min(maximum, score * (maximum / 25)));
  }
...
function getInternalCoverageScores(rawAnswer) {
  ...
  if (current.type !== "introduction") {
    const answer = normalize(rawAnswer);
    const maximum = 100 / current.groups.length;
    return current.groups.map((keywords, index) => (
      Math.min(maximum, scoreEvidence(answer, keywords, index) * (maximum / 25))
    ));
  }
...
function hasClearlyExcessiveLength(rawAnswer, scores) {
  ...
  const current = questions[currentIndex];
  const maximum = 100 / scores.length;
...
const UPDATED_QUESTION_GUIDANCE = {
  ja: [
    null,
    [
      ["志望理由を述べています。", "志望理由が含まれていません。", "志望理由を一つ述べてください。"],
      ["理由を説明しています。", "理由の説明が不足しています。", "なぜそう思うのかを一つ加えてください。"],
      ["前向きな気持ちを伝えています。", "前向きな気持ちが不足しています。", "頑張りたい気持ちや成長したい気持ちを加えてください。"]
    ],
    [
      ["選んだ理由を述べています。", "選んだ理由が含まれていません。", "当社または当校を選んだ理由を一つ述べてください。"],
      ["その理由を説明しています。", "選んだ理由の説明が不足しています。", "魅力に感じた点や自分に合う点を一つ加えてください。"],
      ["入社または入学への意欲を伝えています。", "入社または入学への意欲が不足しています。", "入社または入学後に頑張りたいことを加えてください。"]
    ],
    [
      ["頑張ったことを述べています。", "頑張ったことが含まれていません。", "これまでで一番頑張ったことを一つ述べてください。"],
      ["内容を説明しています。", "頑張った内容の説明が不足しています。", "いつ、何を、どのように頑張ったかを加えてください。"],
      ["学んだことや成長を伝えています。", "学んだことや成長が不足しています。", "その経験から学んだことや成長したことを加えてください。"]
    ],
    [
      ["長所を述べています。", "長所が含まれていません。", "自分の長所を一つ述べてください。"],
      ["理由や具体例を話しています。", "理由や具体例が不足しています。", "その長所が分かる理由や具体例を一つ加えてください。"],
      ["長所を仕事でどう生かすか話しています。", "仕事での生かし方が不足しています。", "その長所を仕事でどう生かしたいかを加えてください。"]
    ],
    [
      ["上司にすぐ報告すると述べています。", "上司にすぐ報告することが含まれていません。", "ミスをしたら上司にすぐ報告すると述べてください。"],
      ["原因を自分で考えると述べています。", "原因を自分で考えることが不足しています。", "なぜミスをしたのか原因を考えることを加えてください。"],
      ["上司の指示を聞いて対応すると述べています。", "上司の指示を聞いて対応することが不足しています。", "上司の指示を聞いて対応すると加えてください。"]
    ],
    [
      ["弱みを正直に述べています。", "弱みが正直に述べられていません。", "自分の弱みを一つ正直に述べてください。"],
      ["改善しようとしていることを話しています。", "改善しようとしていることが不足しています。", "弱みを改善するためにしていることを加えてください。"],
      ["前向きな姿勢で締めくくっています。", "前向きな締めくくりが不足しています。", "これから努力したい、改善したいという前向きな言葉を加えてください。"]
    ],
    [
      ["チームで大切なことを述べています。", "チームで大切なことが含まれていません。", "協力、報告、相談など大切なことを一つ述べてください。"],
      ["理由や具体例を話しています。", "理由や具体例が不足しています。", "それを大切にする理由や具体例を一つ加えてください。"],
      ["仕事でどう実践したいか話しています。", "仕事での実践方法が不足しています。", "仕事でどのように実践したいかを加えてください。"]
    ],
    [
      ["「はい、あります。」または「いいえ、ありません。」と答えています。", "「はい、あります。」または「いいえ、ありません。」の答えが不足しています。", "最初に「はい、あります。」または「いいえ、ありません。」と答えてください。"]
    ],
    [
      ["何が不安なのかを伝えています。", "何が不安なのかが不足しています。", "会話、敬語、専門用語など、何が不安なのかを加えてください。"],
      ["そのために何をしているか話しています。", "不安に対して何をしているかが不足しています。", "勉強、練習、確認、質問など、今していることを加えてください。"]
    ],
    [
      ["将来の目標を述べています。", "将来の目標が含まれていません。", "将来の目標を一つ述べてください。"],
      ["目標のために今していることを話しています。", "目標のために今していることが不足しています。", "今している勉強や努力を一つ加えてください。"],
      ["前向きな気持ちを伝えています。", "前向きな気持ちが不足しています。", "これから頑張りたい、成長したいという気持ちを加えてください。"]
    ]
  ]
};
...
function getIntroductionGuidance(language) {
  ...
  const messages = {
    ja: [
      ...
      [`学校名「${values[3]}」を述べています。`, `学校名「${values[3]}」が含まれていません。`, `学校名「${values[3]}」を回答に入れてください。`]
    ],
    vi: [
...
function renderScoreGuidance(scores, maximum) {
  ...
  const guidance = currentIndex === 0
    ...
    : guidanceSource[language][currentIndex];
